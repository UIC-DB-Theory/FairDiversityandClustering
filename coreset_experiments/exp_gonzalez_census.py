...
def main():
    print("****CORESET EXPERIMENTS - Gonzalez: CENSUS FULL****")
    ...
    resultfile = open("gonzalez_census_coreset_vary_size.csv", "w")
    ...
    for k in k_vals:
        for coreset_size in coreset_sizes:
            ...
            out_f, cout_c = gonzalez_coreset.coreset(features, colors, coreset_size)
            end_time = time.time()
            print('\t coreset size = ', len(out_f))

            t = (end_time - start_time)
            e = 'n/a' #coreset_constructor.e
