...
def scalable_fmmd_modified_greedy2(V: ElemList, EPS: float, k: int, C: int, constr: List[List[int]], dist: Callable[[Any, Any], float]) -> (List[int], float, float):
    t0 = time.perf_counter()
...
def scalable_fmmd_ILP2(V: ElemList, EPS: float, k: int, C: int, constr: List[List[int]], dist: Callable[[Any, Any], float]) -> (List[int], float, float):
    t0 = time.perf_counter()
