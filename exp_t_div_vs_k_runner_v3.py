        ...
        for alg in results_per_k_per_alg[k]:
            if alg not in results[dataset_name]:
                results[dataset_name][alg] = {
                    ...
                    'ys' : {
                        'runtime' : [results_per_k_per_alg[k][alg][4]],
                        'diversity' : [results_per_k_per_alg[k][alg][3]]
                    }
                }
            else:
                results[dataset_name][alg]['xs']['k'].append(k)
                results[dataset_name][alg]['ys']['runtime'].append(results_per_k_per_alg[k][alg][4])
                results[dataset_name][alg]['ys']['diversity'].append(results_per_k_per_alg[k][alg][3])
