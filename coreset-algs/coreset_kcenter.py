...
class Coreset_kCenter:
    ...
    def plot2D_coreset(self, coreset_plot_flag=False):
        ...
        title_text = 'k-Center Coreset (size={}) for k={}, epsilon={}, n={}'.format(len(self.coreSet_array), self.k,
                                                                                    self.epsilon, self.x_array.shape[0])
    ...
    def greedy_kcenter(self):
        ...
        while len(self.centers) < self.k:
            ...
            point_distances = [min(hf.dist(self.x_array[i], maximum_dist_point), point_distances[i]) for i in
                               range(len(self.x_array))]
    ...
    def compute_kCenter_Coreset(self):
        ...
        print("Generated (k,epsilon) Center Coreset of size={} on Input dimensions={}".format(len(self.coreSet_array),
                                                                                              self.x_array.shape))
